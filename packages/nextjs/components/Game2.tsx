...
const Game2 = () => {
  ...
  const startGame = () => {
    ...
    k.loadSprite("btc", "assets/bitcoin-logo.png");
    k.loadSprite("roadblock", "assets/roadblock.png");
    ...
    k.addLevel(
      ...
      ],
      {
        ...
        tileHeight: 50,
        tiles: {
          x: () => [k.sprite("roadblock"), k.area(), k.body()],
          e: () => [k.sprite("bopbymhgn"), k.area(), k.body(), "bopbymhgn"],
          p: () => [k.sprite("btc"), k.area(), k.body(), "bopbymhgn"],
        },
      },
    );
